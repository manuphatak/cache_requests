...
* concatenate                   - flatten documents, insert spaces.
...
# CONSTANTS
README_OUT = PROJECT('README.rst')
CONTRIBUTING_OUT = PROJECT('CONTRIBUTING.rst')
...
if __name__ == '__main__':
    ...
    routine(include_readme_docs, README_OUT)
    routine(include_contributing_docs, CONTRIBUTING_OUT)
